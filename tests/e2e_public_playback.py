...
def check_admin_mode(page) -> None:
    ...
    expect(page.locator(".admin-run-panel")).to_be_visible()
    expect(page.locator("[data-action='live-playback-start']")).to_be_visible()
    expect(page.locator("#adminMainFlow")).to_be_visible()
    expect(page.locator(".control-panel")).to_be_visible()
    expect(page.locator("#adminAdvancedTools > summary")).to_be_visible()
    expect(page.locator("[data-action='trigger-manual-ingest']")).to_be_hidden()
    page.locator("#adminAdvancedTools > summary").click()
