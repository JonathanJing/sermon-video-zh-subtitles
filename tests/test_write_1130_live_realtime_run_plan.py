...
class Write1130LiveRealtimeRunPlanTest(unittest.TestCase):
    def test_plan_documents_live_realtime_and_offline_handoff_policy(self):
        ...
        self.assertEqual(report["modelPolicy"]["stableCorrectionModel"], "gpt-5.5-mini")
        self.assertEqual(report["modelPolicy"]["offlineAsrModel"], "gpt-4o-transcribe")
        self.assertEqual(report["modelPolicy"]["offlineTranslationModel"], "gpt-5.5-mini")
        self.assertEqual(report["modelPolicy"]["forbiddenOfflineModel"], "gpt-realtime-translate")
        self.assertTrue(report["modelPolicy"]["doNotSubstituteGpt55ForGpt55Mini"])
        ...
        self.assertEqual(server_command[server_command.index("--stable-model") + 1], "gpt-5.5-mini")
        ...
        self.assertEqual(stabilizer_command[stabilizer_command.index("--model") + 1], "gpt-5.5-mini")
        ...
        self.assertIn("gpt-5.5-mini", offline_commands)
