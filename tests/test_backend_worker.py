...
class BackendWorkerTest(unittest.TestCase):
    ...
    def test_build_generation_plan_runs_caption_publish_before_optional_notes(self):
        ...
        self.assertIn("--model gpt-5.5-mini", joined_commands[0])
        ...
        self.assertIn("--model gpt-5.5-mini", joined_commands[2])
        ...
        self.assertIn("--expected-translation-model gpt-5.5-mini", joined_commands[4])
        ...
        self.assertIn("--offline-translation-model gpt-5.5-mini", joined_commands[7])
        self.assertIn("--realtime-draft-model gpt-realtime-translate", joined_commands[7])
        self.assertIn("--stable-correction-model gpt-5.5-mini", joined_commands[7])
    ...
    def test_build_generation_plan_can_include_insights_after_caption_publish(self):
        ...
        self.assertIn("--model gpt-5.5-mini", joined_commands[8])
