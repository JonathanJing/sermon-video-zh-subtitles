...
![Dev 审核、main 晋升与 Firebase 正式发布的边界](docs/diagrams/firebase-release-flow.svg)
...
![正式站中文界面，内容语言为中文](docs/assets/firebase-production-2026-09-25-zh.jpg)

**西语界面，中文内容**

![正式站西语界面，内容语言仍为中文](docs/assets/firebase-production-2026-09-25-es.jpg)
