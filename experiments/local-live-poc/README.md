...
For viewers using cellular data instead of the venue Wi-Fi, the recorded design uses Firebase Hosting + Realtime Database and an outbound-only publisher from the MacBook. It is not deployed yet; see [PUBLIC_SHARING.zh.md](./PUBLIC_SHARING.zh.md).
