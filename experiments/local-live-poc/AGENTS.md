...
- Sunday live is an independent `live_session`, not a four-layer prepared-production run. If a finalized recording is later reused for durable translation, audio, or release, begin at Layer 1 and rebuild source/English anchors; never promote live machine Chinese into a Layer 2 approval.
