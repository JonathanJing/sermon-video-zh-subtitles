...
4. 做模型或 Cloud Run 工作前，读 [model-provider-comparison.zh.md](./model-provider-comparison.zh.md) 和 [cloud-run-deployment-prep.zh.md](./cloud-run-deployment-prep.zh.md)。
