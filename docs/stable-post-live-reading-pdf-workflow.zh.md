...
5. 生成并校验中英对照阅读版 PDF 和中文证道同行 PDF
...
- 基于人工确认的证道时间窗生成中英阅读稿
- 产出阅读版 PDF 和证道同行 PDF，作为两个统一的核心交付物
...
阅读版 PDF 和证道同行 PDF 是这条稳定工作流统一的两个核心交付物。同行 PDF 只保留证道摘要、信息脉络、明确经文和逐段可追溯的讲道摘录（中文译文），不生成讨论题、反思题、祷告或应用任务。
