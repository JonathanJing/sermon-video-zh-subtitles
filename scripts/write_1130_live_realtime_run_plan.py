...
def build_plan(args: argparse.Namespace) -> dict[str, Any]:
    ...
    return {
        ...
        "passCriteria": [
            ...
            "Stable corrections are gpt-5.4-mini caption_final events that match realtime draft segmentId.",
            "Offline post-live route never uses gpt-realtime-translate.",
            "Offline no-caption fallback uses gpt-4o-transcribe before gpt-5.4-mini translation.",
        ],
        "guards": {
