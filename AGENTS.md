...
Before changing sermon wording for a series, use the relevant entries in the [shared terminology table](docs/series-terminology.zh.md). Add a verified new series with source evidence when it enters production. Reading or updating this table does not establish that a producer consumed it.
